...
public class Setting extends BaseActivity {
    private static final String TAG = com.hyphenate.chatuidemo.ui.MainActivity.class.getSimpleName();
        ...
        @Override public boolean onMenuItemClick(MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.menu_create_group:
                    ...
                    startActivity(new Intent(Setting.this, InviteMembersActivity.class));
                    break;

                case R.id.menu_public_groups:
                    startActivity(new Intent(Setting.this, PublicGroupsListActivity.class));
                    break;
                case R.id.menu_add_contacts:
                    startActivity(new Intent(Setting.this, AddContactsActivity.class));
                    break;
            }
                ...
                conflictBuilder.setPositiveButton(R.string.common_ok,
                        new DialogInterface.OnClickListener() {
                            ...
                            @Override public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                finish();
                                Intent intent = new Intent(Setting.this, SignInActivity.class);
